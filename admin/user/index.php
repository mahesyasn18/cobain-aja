		...
		<table align="center" cellpadding="10" cellspacing="0" width="100%">
			<tr>
				<td height="80px" bgcolor="#20B2AA" colspan="3">
					...
					<br>
					<h4 style="color: white;">Hello <?php echo $_SESSION['username']; ?> Selamat Datang di Laman User</h3>
				</td>
			</tr>
			<tr>
				...
				<fieldset>
					<legend><font color="green"><b>DATA USER</b></font></legend>
                            ...
                            <a href="tambahuser.php"><button type="button" id="submit-btnn"><b>+ Tambah User</b></button></a> | <a href="../index.php"><button type="button" id="submit-btnn"><b>Ke Halaman Admin</b></button></a> | <a href="logout.php" align="right"><button type="button" id="submit-btnn"><b>LOGOUT</b></button></a><br/><br/>
                                <tr>
                                    <th>Nomor</th> <th>Nama</th> <th>Username</th> <th>Password</th> <th>Update</th>
                                </tr>
                                <?php  
